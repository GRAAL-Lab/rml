...
0. Definition of derived Eigen types such as **Rotation** and **Homogeneus Transformation** matrices, **Euler angles** (using the zyx convention, i.e. the yaw-pitch-roll order), and all the functions to convert from one type to another.
