...
YouBotVehicleModel::YouBotVehicleModel(const std::string id) : VehicleModel(id)
{
	 ...
	 *
	 */
	vJac(0,3) = 0.0;  vJac(0,4) = 0.0;  vJac(0,5) = 0.0;
	vJac(1,3) = 0.0;  vJac(1,4) = 0.0;  vJac(1,5) = 0.0;
	vJac(2,3) = 1.0;  vJac(2,4) = 0.0;  vJac(2,5) = 0.0;
	vJac(3,3) = 0.0;  vJac(3,4) = 1.0;  vJac(3,5) = 0.0;
	vJac(4,3) = 0.0;  vJac(4,4) = 0.0;  vJac(4,5) = 1.0;
	vJac(5,3) = 0.0;  vJac(5,4) = 0.0;  vJac(5,5) = 0.0;
	SetJacobian(vJac);
